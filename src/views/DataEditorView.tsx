      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <section className="bg-surface-container-low border border-outline-variant/20 rounded-2xl p-8 space-y-8 flex flex-col shadow-xl">
          ...
          <div className="space-y-6">
            <FormField label="name" value={profile?.name || ''} type="text" />
            <FormField label="role" value={profile?.role || ''} type="text" />
            <FormField label="bio" value={profile?.bio || ''} type="textarea" />
          </div>
        </section>
          ...
          <div className="space-y-6">
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-on-surface-variant opacity-60">skills</label>
           ...
           <div className="relative group">
              <div className="absolute top-4 right-4 z-10 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                <button
                  ...
                  className="p-2 bg-surface-container rounded-lg border border-outline-variant/30 text-on-surface-variant hover:text-on-surface transition-colors"
                >
                  <Copy size={16} />
                </button>
              </div>
